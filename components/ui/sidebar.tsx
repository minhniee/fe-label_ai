...
function SidebarMenuSkeleton({
  ...
  // Fixed width to avoid hydration mismatch (Math.random() causes different values on server vs client)
  // Using a consistent width that looks good for skeleton loading
  const width = "70%"
